...
define job_type_to_be_cleaned=StormonHostJobs
...
BEGIN
    ...
    jobName := 'StormonHostJobs';

    jobTargets := MGMT_JOB_TARGET_LIST();
    jobTargets.extend(2);
    jobTargets(1) := MGMT_JOB_TARGET_RECORD('gede.us.oracle.com', 'host');
    jobTargets(2) := MGMT_JOB_TARGET_RECORD('pinnacle.us.oracle.com', 'host');
    ...
    jobParams(6) := MGMT_JOB_PARAM_RECORD('em_target_type', 1,'oracle_sysman_node',null);
    ...
    MGMT_JOBS.submit_job(
		jobName,					-- jobname
		'This job executes the Stormon Host Job',	-- description
                'StormonHostJobs',				-- jobtype
